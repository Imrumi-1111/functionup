...
const newPerson = {
    ...person,name: "Rahul",address: {...person.address,pincode: 4567,emails: ["asd@outlook.com",//used spread operator to destructure but in video I said rest operator by mistake
            ...person.address.emails.slice(1)
        ]
    }
};
